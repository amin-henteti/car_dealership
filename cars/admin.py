...
class CarsAdmin(admin.ModelAdmin):
    def thumbnail(self, object):
        return format_html('<img src={}  width=66 style="border-radius: 10px"'.format(object.main_image.url))
    thumbnail.short_description = 'Photo'
    list_display = ('id', 'title', 'thumbnail', 'price', 'miles', 'year', 'availibility', 'created_date')
